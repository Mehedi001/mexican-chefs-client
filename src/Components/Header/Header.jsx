            ...
            <div className="navbar-end">
                <div className="avatar">
                    <div className="w-12 mr-4 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                        {user? <img src={user?.photoURL} title={user?.displayName}  /> : <img title="This is Profile photo of user" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Circle-icons-profile.svg/2048px-Circle-icons-profile.svg.png" alt="this is profile photo of user" />}
                    </div>
                </div>
                {
